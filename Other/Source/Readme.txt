...
user in an INI file next to KiCadPortable.exe called KiCadPortable.ini.
...
copy AppNamePortable.ini from this directory to KiCadPortable.ini next to
KiCadPortable.exe. The options in the INI file are as follows:
